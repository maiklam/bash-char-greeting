...
lettersMissingFromCharacters=`comm -1 -2 -3 /tmp/.greeting/first-letters-nationalities /tmp/.greeting/first-letters-characters`
lettersMissingFromNationalities=`comm -1 -1 -3 /tmp/.greeting/first-letters-nationalities /tmp/.greeting/first-letters-characters`
